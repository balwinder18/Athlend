              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-2/3 md:pl-8 mt-6 md:mt-0">
                  ...
                  <div className="flex space-x-4">
                    <button 
                      onClick={handleEdit} 
                      className={`px-4 py-2 rounded-md shadow-sm text-sm font-medium text-white ${isEditing ? 'bg-green-600 hover:bg-green-700' : 'bg-blue-600 hover:bg-blue-700'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`}
                    >
                      {isEditing ? 'Save Changes' : 'Edit Profile'}
                    </button>
                  </div>
